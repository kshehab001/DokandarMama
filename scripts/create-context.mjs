...
const content = `import React, { createContext, useContext, useEffect, useState, useMemo } from "react"
...
fs.writeFileSync('artifacts/dokandar-mama/src/context/shop-theme-context.tsx', content, 'utf8');
console.log('shop-theme-context.tsx created successfully');
